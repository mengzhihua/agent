...
_agent() {
  ...
  local cmds="acp eval doctor update uninstall completion config init login logout --help --version --print --quiet --output-format --yes --plan --workspace --resume --list --model --provider --sandbox --browser --no-mcp"
